...
Defined in: [packages/oidc/src/exchange-vercel-oidc-token.ts:138](https://github.com/jing5460/vercel/blob/main/packages/oidc/src/exchange-vercel-oidc-token.ts#L138)
