...
Defined in: [packages/oidc/src/get-vercel-oidc-token-with-refresh.ts:96](https://github.com/jing5460/vercel/blob/main/packages/oidc/src/get-vercel-oidc-token-with-refresh.ts#L96)
